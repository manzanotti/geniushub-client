...
from geniushubclient.const import ITYPE_TO_TYPE, ZONE_KIT, ZONE_TYPE
from geniushubclient.zoneclasses.properties import Properties


class PropertiesUpdateV3Tests(unittest.TestCase):
    ...
    def test_update_when_iType_set_then_properties_type_name_is_set_correctly(self):
        ...
        for zone_type in test_values:
            ...
            with self.subTest(
                zone_type=zone_type, zone_type_text=zone_type_text
            ):  # noqa: E501
                self.raw_json["iType"] = zone_type
                self.raw_json["zoneSubType"] = 1
                properties = Properties()
    ...
    def test_update_when_iType_TPI_and_subzonetype_zero_then_properties_type_set_to_wet_underfloor(
        self,
    ):  # noqa: E501
    ...
    def test_update_when_iType_TPI_and_subzonetype_zero_then_properties_type_name_set_to_wet_underfloor(
        self,
    ):  # noqa: E501
    ...
    def test_update_when_zone_does_not_have_room_sensor_then_has_room_sensor_false(
        self,
    ):  # noqa: E501
    ...
    def test_update_when_zone_does_have_room_sensor_then_has_room_sensor_true(
        self,
    ):  # noqa: E501
