...
class PropertiesUpdateV3Tests(unittest.TestCase):
    ...
    def test_update_when_iType_TPI_and_subzonetype_zero_then_properties_type_set_to_wet_underfloor(self):  # noqa: E501
    ...
    def test_update_when_iType_TPI_and_subzonetype_zero_then_properties_type_name_set_to_wet_underfloor(self):  # noqa: E501
