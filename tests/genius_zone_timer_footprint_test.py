...
class GeniusZoneTimerFootprintTests(unittest.TestCase):
    """
    ...
    def test_when_footprint_schedule_updated_then_footprint_schedule_has_seven_days(self):  # noqa: E501
        "Check that the footprint schedule has seven days of data"

        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        self.assertEqual(len(genius_zone.footprint_schedule), 7)

    def test_when_footprint_schedule_updated_then_footprint_schedule_first_day_has_correct_index(self):  # noqa: E501
        "Check that the first day of the footprint schedule has the correct index set"

        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        day = genius_zone.footprint_schedule[0]
        self.assertEqual(day.index, 0)

    def test_when_footprint_schedule_updated_then_footprint_schedule_first_day_has_correct_name(self):  # noqa: E501
        "Check that the first day of the footprint schedule has the correct name set"
    ...
    def test_when_footprint_schedule_updated_then_footprint_schedule_first_day_first_heating_period_has_correct_end(self):  # noqa: E501
        "Check that the first heating period of the first day of the footprint schedule has the correct end time set"  # noqa: E501
    ...
    def test_when_last_setpoint_then_footprint_schedule_last_day_last_heating_period_has_correct_end(self):  # noqa: E501
        ...
        heating_period = day.heating_periods[len(day.heating_periods) - 1]
