...
class GeniusZoneTimerScheduleTests(unittest.TestCase):
    """
    ...
    def test_when_timer_schedule_updated_then_timer_schedule_has_seven_days(self):
        "Check that the timer schedule has seven days of data"

        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        self.assertEqual(len(genius_zone.timer_schedule), 7)

    def test_when_timer_schedule_updated_then_timer_schedule_first_day_has_correct_index(self):  # noqa: E501
        "Check that the first day of the timer schedule has the correct index set"

        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        day = genius_zone.timer_schedule[0]
        self.assertEqual(day.index, 0)

    def test_when_timer_schedule_updated_then_timer_schedule_first_day_has_correct_name(self):  # noqa: E501
        "Check that the first day of the timer schedule has the correct name set"
    ...
    def test_when_timer_schedule_updated_then_timer_schedule_first_day_first_heating_period_has_correct_end(self):  # noqa: E501
        "Check that the first heating period of the first day of the timer schedule has the correct end time set"  # noqa: E501
    ...
    def test_when_next_heating_period_does_not_have_start_time_then_timer_schedule_first_day_second_heating_period_has_correct_end(self):  # noqa: E501
        ...
        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        day = genius_zone.timer_schedule[0]
        heating_period = day.heating_periods[1]
        self.assertEqual(heating_period.end, 86400)

    def test_when_last_setpoint_then_timer_schedule_last_day_last_heating_period_has_correct_end(self):  # noqa: E501
        "Check that the last heating period of the last day of the timer schedule has the correct end time set"  # noqa: E501

        genius_zone = GeniusZone(self._device_id, self.raw_json, self.hub)
        day = genius_zone.timer_schedule[6]
        heating_period = day.heating_periods[0]
        self.assertEqual(heating_period.end, 86400)
