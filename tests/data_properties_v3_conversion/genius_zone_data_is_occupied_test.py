...
class GeniusZoneDataIsOccupiedTests(unittest.TestCase):
    ...
    def test_when_zone_does_not_have_room_sensor_then_occupied_is_false(self):  # noqa: E501
        "Check that occupied is false when the zone does not have a room sensor"
    ...
    def test_when_is_night_then_occupied_is_false(self):  # noqa: E501
    ...
    def test_when_all_conditions_correct_then_occupied_is_true(self):  # noqa: E501
